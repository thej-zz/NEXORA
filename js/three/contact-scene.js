/* ============================================================
   CONTACT PAGE — ambient background scene
   ------------------------------------------------------------
   Same synchronized-intelligence-network approach as the members
   page scene, retargeted at #contact-canvas. Written defensively
   the same way: hooks into window.SceneRegistry if it exists,
   otherwise manages its own resize / visibility / reduced-motion
   listeners standalone.
   ============================================================ */
(function () {
  'use strict';
  ...
  var NODE_COUNT = isSmall ? 30 : 80;
  var RADIUS = isSmall ? 8 : 13;
  ...
  var lineMat = new THREE.LineBasicMaterial({ color: accent2Color, transparent: true, opacity: 0.13 });
